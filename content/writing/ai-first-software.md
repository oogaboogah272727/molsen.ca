...
date: 2024-04-04
description: "Generative AI has solved language. That's enough to change software design—not in the future, but right now."
...
→ For the mechanism behind this shift, see [Agentic AI as Universal Interface](/writing/agentic-ai-universal-interface/)
→ For what this means as capabilities improve, see [Automating Expertise Gets Easier and Easier](/writing/automating-expertise-gets-easier/)
