...
The insight from [The Real Job of Support Teams](/writing/support-team-real-job/) applies directly: "Wasted overhead time is support's finger on the scale of the work/life balance." The secretary kept that finger off the scale. The DIY era put it back on.
...
[Agentic AI as Universal Interface](/writing/agentic-ai-universal-interface/) describes why this works now: "Two barriers have prevented most expertise from becoming software: coding skill and system access knowledge. Agentic AI removes both."
...
- **More capable than any secretary.** It can write code, analyze data, draft in any style, translate between formats. A 1960s secretary couldn't build you a financial model. An AI assistant can.

- **More capable than the professional at execution tasks.** Most of us are mediocre at formatting, formula construction, and slide design. We learned these skills reluctantly and practice them occasionally. The AI executes them reliably.
